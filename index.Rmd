...
.footnoteRight[• 100 µM DBP<br>• Ctrl = water]
...
.footnoteLeft[[Per- and Polyfluoroalkyl <br> Substances (PFAS) Report](https://www.whitehouse.gov/wp-content/uploads/2023/03/OSTP-March-2023-PFAS-Report.pdf)]
---
...
# Detection of 8:2 FTAC modified peptides hampered by low-intensity and overlapping retention times of modified peptides 
<!--adjust label on y-axis to state "Cysteine containing peptide" --> 

.center[
.hide-bg[
![:scale 80%](images/04-FSPE/si-bsa-anno-peps2.png)
]
]
...
# Refinement of Fluorous Solid Phase Extraction enables the selective enrichment of long-chain PFAS adducted peptides
